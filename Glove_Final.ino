...
void loop()
{
  ...
  XBee.write("<");      // This character represent the beginning of the package of the five values
  XBee.write(thumb);    // The values are sent via the Tx pin (the digital pin 1)
  XBee.write(index);  
  XBee.write(middle);  
  XBee.write(annular);
  XBee.write(pinky);
